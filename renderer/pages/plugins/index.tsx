      ...
      <Layout>
        ...
        <section className={styles.plugins}>
          ...
          <ul className={styles.pluginsCategory}>
            ...
            <li>
              <a data-category="installed" onClick={this.selectCategory} className={this.isSelected('installed')}>
                Installed
              </a>
            </li>
            <li>
              <a data-category="available" onClick={this.selectCategory} className={this.isSelected('available')}>
                Available
              </a>
            </li>
          </ul>
